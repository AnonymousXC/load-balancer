...
backends:
	...
	@PORT=8081 SID=1 go run ./cmd/server & echo $$! > ./build/.backend1.pid
	@PORT=8082 SID=2 go run ./cmd/server & echo $$! > ./build/.backend2.pid
	@PORT=8083 SID=3 go run ./cmd/server & echo $$! > ./build/.backend3.pid
	@sleep 1
